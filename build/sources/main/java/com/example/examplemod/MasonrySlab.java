...
public  abstract class MasonrySlab extends BlockSlab
{
    public static final PropertyEnum<Variant> VARIANT = PropertyEnum.<Variant>create("variant", Variant.class);

    public MasonrySlab(String name, Material material) {
        super(material);
    ...
    public static class Double extends MasonrySlab
    {
    ...
    public static class Half extends MasonrySlab
    {
